...
const Footer = () => {
  return (
    <div>
      <div className="relative mt-[-1px] lg:pt-[248px] md:pt-[150px] sm:pt-[100px] pt-16 pb-[150px] max-sm:pb-[100px] lg:pb-[267px] md:pb-[150px] bg-[#0A4740]">
        <div
          data-aos="fade-down"
        ...
        <img
          src={footerdino}
          alt="dino"
          className="absolute right-[10%]  animate-herobounceanimnate lg:bottom-[2%] bottom-0 hidden md:block max-lg:w-[150px] max-lg:h-[200px]"
        />
      </div>
    </div>
  );
