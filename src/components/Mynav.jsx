          ...
          <li className="gap-2 items-center sm:hidden flex ">
            ...
            >
               <svg
                ...
                className="group-hover:scale-110 group-hover:fill-black duration-300"
              >
                <circle cx="18.5" cy="18.5" r="18" stroke="black" className="group-hover:stroke-white duration-300" />
                <path
            ...
            >
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="group-hover:fill-black group-hover:scale-110 duration-300"
              >
                <circle
                  cx="18.5"
                  cy="18.5"
