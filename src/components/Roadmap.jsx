...
const Roadmap = () => {
  return (
    ...
    >
      ...
      />
      <div className="sm:hidden block absolute sm:left-[70px] left-[40px] bottom-0 top-[12%] h-[85%] w-[15px] border-l-[11px] border-dashed border-[#0a4740]"></div>
...
">
        ...
        <div
          data-aos="fade-left"
          data-aos-duration="1000"
          className="max-sm:after:absolute max-sm:relative after:bg-[#23AAAC]  max-sm:after:border-2 after:border-white  after:w-[30px] after:h-[30px] after:rounded-full after:left-[5.5%] after:top-[10%] max-w-[440px] lg:max-w-[630px] sm:ml-[360px] sm:pb-[100px]  sm:pt-[128px] mt-[70px]"
        >
          <div className="max-sm:flex-col flex sm:items-center max-sm:ml-[90px] gap-[45px]">
