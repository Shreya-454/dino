...
">
            ...
            <ul>
              <li className="  list-disc text-[20px] leading-[24px] font-normal font-bal text-white">
                Launch $DINO & Website & Social Media.
              </li>
              <li className=" pt-4 list-disc text-[20px] leading-[24px] font-normal font-bal text-white">
