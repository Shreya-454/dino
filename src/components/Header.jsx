...
const Header = () => {
  return (
    <div className="bg-[url(./assets/images/herobg.webp)] bg-full bg-center bg-no-repeat sm:min-h-screen relative overflow-x-clip max-sm:h-[600px] ">
       <img src={dino2} alt="dino" className=" absolute bottom-[18%] right-[40%] animate-movebike1 hidden sm:block" />
      <img src={dino1} alt="dino" className="absolute right-[10%] md:bottom-[10%] bottom-0 animate-movebike2 max-sm:w-[200px] max-sm:h-[200px]" />
      ...
      <div className="max-w-[1164px] mx-auto px-3 pb-96">
        <div className="flex md:flex-row flex-col-reverse flex-wrap -mx-3">
          <div className="md:w-1/2 w-full flex items-end justify-center">
            <img src={aeroplane} alt="img" className=" animate-airopalneanimation max-[400]:w-full" />
          </div>
          <div className="md:w-1/2 w-full px-3 flex justify-center lg:block md:flex-col  items-center">
