...
const BackToTop = () => {
    ...
    return (
        <div>
            <button className="group animate-bounce flex justify-center items-center p-2 w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] bg-[#56DB2A] rounded-full fixed right-[1.7%] bottom-[10px] z-30 transition-all ease-linear duration-300 "
                onClick={scrollToTop}
                style={{
